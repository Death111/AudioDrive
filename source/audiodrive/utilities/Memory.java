...
public class Memory {
	...
	private static Logger logger = Logger.getLogger(Memory.class);
	...
	public static void print() {
		...
		logger.info("Free memory: " + inMB(Runtime.getRuntime().freeMemory()));

		/* This will return Long.MAX_VALUE if there is no preset limit */
		long maxMemory = Runtime.getRuntime().maxMemory();
		/* Maximum amount of memory the JVM will attempt to use */
		logger.info("Maximum memory: "
				+ (maxMemory == Long.MAX_VALUE ? "no limit" : inMB(maxMemory)));

		/* Total memory currently in use by the JVM */
		logger.info("Total memory: " + inMB(Runtime.getRuntime().totalMemory()));
		...
		for (File root : roots) {
			...
			logger.info("Total space: " + inGB(root.getTotalSpace()));
			logger.info("Free space: " + inGB(root.getFreeSpace()));
			logger.info("Usable space: " + inGB(root.getUsableSpace()));
		}
	}
