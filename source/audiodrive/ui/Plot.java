...
/**
 * A simple class that allows to plot float[] arrays to a swing window. The first function to plot that is given to this class will set the minimum and maximum height values. I'm
 * not that good with Swing so i might have done a couple of stupid things in here :)
 *
 * @author mzechner
 *
 */
